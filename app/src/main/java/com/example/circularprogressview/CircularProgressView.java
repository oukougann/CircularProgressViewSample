...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, AttributeSet attrs) {
        ...
        //中间圆的背景颜色  默认 - 白色
        mCircleBackground = typedArray.getColor(R.styleable.CircularProgressView_circleBackground, Color.WHITE);
        //外圆环的颜色  默认 - 灰色
        roundColor = typedArray.getColor(R.styleable.CircularProgressView_circleColor, Color.GRAY);
        //外圆环的颜色  动态画圆 - 默认-红色
        mRingColor = typedArray.getColor(R.styleable.CircularProgressView_ringColor, Color.RED);
        //中间圆的半径
        mRadius = typedArray.getInt(R.styleable.CircularProgressView_radius, 300);
        //字体颜色 默认 - 灰色
        mTextColor = typedArray.getColor(R.styleable.CircularProgressView_textColor, Color.GRAY);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        roundColorPaint.setStrokeWidth((float)(0.075*mRadius)); //设置外圆环的宽度（默认灰色的圆环）
